...
Use [Maintenance map](maintenance-map.md). It routes changes by behavior: trigger policy, GTD secretary rules, Dashboard, IM docs, setup, upgrade, uninstall, and local tools.
