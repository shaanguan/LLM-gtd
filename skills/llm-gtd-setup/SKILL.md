...
> "系统搭好了。接下来我们把你的待办收进来——选一种方式开始：
>
> **A. 7 天上手（推荐）** — 想先体验一遍 GTD 流程？我帮你导入 7 天引导任务，每天一个小练习，从零建立习惯。
>
> **B. 直接告诉我** — 你一条条说，我帮你存。脑子里飘着什么就说什么。
>
> **C. 给我一个链接或地址** — 你现有的待办清单在哪？钉钉文档、飞书文档、本地文件路径都行，我去读然后导入。
>
> **D. 直接粘贴** — 把你现有的待办列表复制粘贴过来，我批量导入。
>
> 选哪个？"
...
**注意**：B/C/D 三条路可以混合使用。用户导完一批后 Agent 应该主动问"还有别的来源要导入吗？"，直到用户说够了为止。
